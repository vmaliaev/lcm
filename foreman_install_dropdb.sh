...
cp -r ./lcm/deployment_scripts/puppet/modules/plugin_lcm/manifests/foreman_ext.pp /etc/fuel/plugins/fuel-plugin-lcm-2.0/puppet/modules/plugin_lcm/manifests/ ; cp ./lcm/foreman_main.pp /etc/fuel/plugins/fuel-plugin-lcm-2.0/puppet/manifests/
