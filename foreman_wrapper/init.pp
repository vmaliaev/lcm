...
class foreman_wrapper (
  ...
  $email_smtp_password       = $::foreman::params::email_smtp_password,
        ...
        notice('VAL notice: BEGIN foreman_wrapper')
        notify{'VAL notify: BEGIN foreman_wrapper':}
...
##############################################################################################3
    ...
    if $::foreman::passenger {
      ...
      $foreman_service = Class['foreman::service']
        ...
        notice('VAL notice: START pending-migration')
        notify{'VAL notify: START pending-migration':}
...
#    class { $db_class: } ~>
	...
	notice('VAL notice: END foreman_wrapper')
	notify{'VAL notify: END foreman_wrapper':}
#    class { '::foreman::service': }
##############################################################################
